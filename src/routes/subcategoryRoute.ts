...
router.post(
  "/subcategory",
  validateSchema(subcategorySchema.subcategoryAddSchema),
  checkAuth,
  checkRole,
...
router.put(
  "/subcategory",
  validateSchema(subcategorySchema.subcategoryUpdateSchema),
  checkAuth,
  checkRole,
...
router.delete(
  "/subcategory",
  validateSchema(subcategorySchema.subcategoryDeleteteSchema),
  checkAuth,
  checkRole,
